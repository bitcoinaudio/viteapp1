...
function VinylRecord({ text }) {
  return (
    <svg width="800" height="800" viewBox="0 0 300 300">
      ...
      <defs>
      <pattern id="imagePattern" patternUnits="userSpaceOnUse" width="300" height="300">
          <image href="/photo_2024-10-28_23-50-57.jpg" width="300" height="300" />
        </pattern>
      ...
      {/* <circle cx="150" cy="150" r="145" fill="url(#vinylGradient)" /> */}
        ...
        {/* Main vinyl disc with image texture */}
        <circle cx="150" cy="150" r="145" fill="url(#imagePattern)" />
      
      {/* Overlay with semi-transparent gradient */}
      {/* <circle cx="150" cy="150" r="145" fill="url(#vinylGradient)" fillOpacity="0.3" /> */}
